export default {
  ...
  usage: {
    ...
    latencyDuration: '总耗时',
    latencyHandler: 'Handler 全链路',
    latencyForward: '最终 Forward',
    latencyFirstVisible: '首个可见输出',
    latencyLegacyTtft: '旧 TTFT（协议相关）',
    latencyLegacyTtftUnknown: '旧 TTFT 不可用',
    semanticOutputMissing: '未观察到语义输出',
    semanticOutputNotCommitted: '已观察，未提交下游',
    semanticOutputUnknown: '历史 / 未覆盖',
    attemptSummary: '{attempts} 次尝试 / {switches} 次换号',
    attempts: '尝试次数',
    switches: '换号次数',
    terminalKind: '终态类型',
    avgHandlerDuration: '平均 Handler 全链路',
    handlerDurationSamples: '{count} 条已观测请求',
    observability: {
      title: '请求可观测详情',
      attempts: '尝试时间线',
      truncated: '中间 {count} 次尝试已折叠',
      forward: 'Forward 耗时',
      outcome: '结果',
      reason: '原因',
      nextAction: '后续动作',
