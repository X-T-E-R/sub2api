export default {
    accounts: {
      ...
      usageWindow: {
        ...
        claude: 'Claude',
        antigravityUnavailable: '配额信息不可用',
        remainingQuota: '剩余额度',
        quotaStaleCompact: '旧数据',
        quotaPartialCompact: '不完整',
        quotaSource: '来源：{source}',
        quotaCompactHint: '每个模型族显示余量最低的窗口，展开查看全部窗口和积分。',
        explicitFiveHour: '5 小时',
        explicitWeekly: '每周',
        explicitWindowsUnavailable: '暂无窗口额度',
        explicitWindowsPartial: '部分窗口额度不可用',
        modelQuotaDetails: '模型剩余额度',
        resetUnknown: '重置时间未知',
        resetElapsed: '已过重置时间 · {time}',
        resetCountdown: '{duration} · {time}',
        observedAt: '观测于 {time}',
        antigravityPartial: '部分模型配额不可用',
        antigravityStale: '当前为缓存观测，点击查询可刷新',
        grokRequests: '请求',
        grokTokens: 'Token',
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '默认关闭，账号隔离仍生效。仅设备统一同账号的设备标识，保留会话和线程区分；设备+会话还会合并不同主会话，但保留各 agent 线程；完全收敛进一步合并线程，会丢失父子线程区分。需要保留多代理结构时，选择关闭或仅设备。',
