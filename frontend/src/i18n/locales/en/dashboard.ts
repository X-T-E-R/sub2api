export default {
  ...
  usage: {
    ...
    latencyHandler: 'Handler E2E',
    latencyForward: 'Final Forward',
    latencyFirstVisible: 'First Visible',
    latencyLegacyTtft: 'Legacy TTFT (protocol-specific)',
    latencyLegacyTtftUnknown: 'Legacy TTFT unavailable',
    semanticOutputMissing: 'No semantic output observed',
    semanticOutputNotCommitted: 'Observed, not committed downstream',
    semanticOutputUnknown: 'Historical / not covered',
    attemptSummary: '{attempts} attempts / {switches} switches',
    attempts: 'Attempts',
    switches: 'Account Switches',
    terminalKind: 'Terminal Kind',
    avgHandlerDuration: 'Avg. Handler E2E',
    handlerDurationSamples: '{count} observed requests',
    observability: {
      title: 'Request Observability',
      attempts: 'Attempt Timeline',
      truncated: '{count} middle attempts folded',
      forward: 'Forward',
      outcome: 'Outcome',
      reason: 'Reason',
