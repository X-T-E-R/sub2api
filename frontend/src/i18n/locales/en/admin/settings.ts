export default {
    settings: {
      ...
      codexSessionAffinity: {
        ...
        behaviorEnrollment: 'Selected groups enroll new explicit Codex root sessions with a durable current-account preference.',
        behaviorCandidates: 'Only daily-session-pool-enabled OAuth/setup-token candidates are eligible. Busy requests wait for a bounded time; genuine quota, authentication, disabled-account, or incompatibility failures may move the preference to another suitable account. Daily session allocation rules are unchanged.',
        behaviorRemoval: 'Removing a group stops new enrollment; existing preferences remain eligible to move among suitable accounts. Requests without an explicit original session use legacy routing.',
        groups: 'Eligible groups',
        groupsHint: 'Only OpenAI and composite groups can enroll new Codex sessions. Selected groups that become ineligible remain listed so you can remove them; removing a group does not clear existing session preferences.',
        ineligible: 'not eligible for new enrollment',
        selectedCount: '{count} selected',
        noGroups: 'No groups available.',
        save: 'Save preference groups',
        saved: 'Codex session account preference saved',
        loadFailed: 'Failed to load Codex session account preference settings',
        saveFailed: 'Failed to save Codex session account preference settings'
      },
      wechatConnect: {
      ...
      openaiExperimentalScheduler: {
        ...
        weightsDescription: 'Blank values use config/environment values; when config is not set, built-in defaults apply. Non-blank page settings take priority. OpenAI always ignores TTFT and historical error rate for scheduler scoring and account escape, even when the experimental scheduler is enabled; these metrics still apply to Grok.',
        defaultPlaceholder: 'config/default: {value}',
        topKLabel: 'TopK',
        priorityWeight: 'Priority',
        loadWeight: 'Load',
        queueWeight: 'Queue',
        errorRateWeight: 'Historical error rate (Grok)',
        ttftWeight: 'TTFT (Grok)',
