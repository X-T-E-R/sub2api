export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'Off by default; account isolation still applies. Device only shares a device identity within the account while keeping sessions and threads distinct. Device + Session also merges separate root sessions but keeps agent threads distinct. Full convergence also merges threads, losing parent/child thread distinctions. Choose Off or Device only to preserve the multi-agent structure.',
      ...
      usageWindow: {
        ...
        geminiQuotaPro: 'GPro',
        geminiQuotaFlash: 'GFl',
        geminiQuotaImage: 'GImg',
        claude: 'Claude',
        antigravityUnavailable: 'Quota unavailable',
        remainingQuota: 'Remaining quota',
        quotaStaleCompact: 'Stale',
        quotaPartialCompact: 'Partial',
        quotaSource: 'Source: {source}',
        quotaCompactHint: 'Lowest remaining window per family. Expand for all windows and credits.',
        explicitFiveHour: '5h',
        explicitWeekly: 'Weekly',
        explicitWindowsUnavailable: 'Window quotas unavailable',
        explicitWindowsPartial: 'Some window quotas are unavailable',
        modelQuotaDetails: 'Model quotas (remaining)',
        resetUnknown: 'Reset time unknown',
        resetElapsed: 'Reset time passed · {time}',
        resetCountdown: '{duration} · {time}',
        observedAt: 'Observed {time}',
        antigravityPartial: 'Some model quota values are unavailable',
        antigravityStale: 'Cached observation; query to refresh',
        grokRequests: 'Req',
        grokTokens: 'Tok',
