...
func init() {
	...
	// usagelogDescTerminalKind is the schema descriptor for terminal_kind field.
	usagelogDescTerminalKind := usagelogFields[37].Descriptor()
	// usagelog.TerminalKindValidator is a validator for the "terminal_kind" field. It is called by the builders before save.
	usagelog.TerminalKindValidator = usagelogDescTerminalKind.Validators[0].(func(string) error)
	// usagelogDescGatewayRequestID is the schema descriptor for gateway_request_id field.
	usagelogDescGatewayRequestID := usagelogFields[43].Descriptor()
	// usagelog.GatewayRequestIDValidator is a validator for the "gateway_request_id" field. It is called by the builders before save.
	usagelog.GatewayRequestIDValidator = usagelogDescGatewayRequestID.Validators[0].(func(string) error)
	// usagelogDescClientRequestID is the schema descriptor for client_request_id field.
	usagelogDescClientRequestID := usagelogFields[44].Descriptor()
