...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "handler_duration_ms", Type: field.TypeInt, Nullable: true},
		{Name: "first_visible_output_ms", Type: field.TypeInt, Nullable: true},
		{Name: "semantic_output_seen", Type: field.TypeBool, Nullable: true},
		{Name: "terminal_kind", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "attempt_count", Type: field.TypeInt, Nullable: true},
		{Name: "account_switch_count", Type: field.TypeInt, Nullable: true},
		{Name: "failed_attempt_duration_ms", Type: field.TypeInt, Nullable: true},
		{Name: "retry_wait_ms", Type: field.TypeInt, Nullable: true},
		{Name: "account_switch_ms", Type: field.TypeInt, Nullable: true},
		{Name: "gateway_request_id", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "client_request_id", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "attempt_ledger", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "codex_telemetry", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
