...
type UsageLogFilters struct {
	...
	GroupID   int64
	RequestID string
	// CorrelationID matches billing request_id plus gateway/client request IDs.
...
type UsageStats struct {
	...
	AverageDurationMs          float64        `json:"average_duration_ms"`
	AverageHandlerDurationMs   float64        `json:"average_handler_duration_ms"`
	HandlerDurationSampleCount int64          `json:"handler_duration_sample_count"`
