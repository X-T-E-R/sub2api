...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		ForwardDurationMs:         l.DurationMs,
		FirstTokenMs:              l.FirstTokenMs,
		HandlerDurationMs:         l.HandlerDurationMs,
		FirstVisibleOutputMs:      l.FirstVisibleOutputMs,
		SemanticOutputSeen:        l.SemanticOutputSeen,
		TerminalKind:              l.TerminalKind,
		AttemptCount:              l.AttemptCount,
		AccountSwitchCount:        l.AccountSwitchCount,
		FailedAttemptDurationMs:   l.FailedAttemptDurationMs,
		RetryWaitMs:               l.RetryWaitMs,
		AccountSwitchMs:           l.AccountSwitchMs,
		GatewayRequestID:          l.GatewayRequestID,
		ClientRequestID:           l.ClientRequestID,
		AttemptLedgerAvailable:    l.AttemptLedgerAvailable,
...
func UsageLogFromServiceAdmin(l *service.UsageLog) *AdminUsageLog {
	...
	return &AdminUsageLog{
		...
		CodexTelemetryAvailable: l.CodexTelemetryAvailable,
