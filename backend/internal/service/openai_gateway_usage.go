...
func (s *OpenAIGatewayService) RecordCyberPolicyUsageLog(ctx context.Context, in CyberPolicyUsageInput) {
	...
	if err := s.RecordUsage(ctx, &OpenAIRecordUsageInput{
		...
		CyberBlocked:       true,
		RequestObservation: in.RequestObservation,
	}); err != nil {
...
func (s *OpenAIGatewayService) RecordUsage(ctx context.Context, input *OpenAIRecordUsageInput) error {
	...
	usageLog := &UsageLog{
		...
		CodexTelemetry:           cloneCodexTelemetry(result.CodexTelemetry),
	...
	usageLog.CodexTelemetryAvailable = usageLog.CodexTelemetry != nil
